...
namespace CALCULADORA
{
    class Program
    {
        ...
        {
            float num1 = 0; float num2 = 0, total;
            string operacao;
            total = 0;
            ...
            num1 = float.Parse(Console.ReadLine());     //Armazenar o valor informado pelo usuário no int 'num1'.
            ...
            num2 = float.Parse(Console.ReadLine());     //Armazenar o valor informado pelo usuário no int 'num2'.
